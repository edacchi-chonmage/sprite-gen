    ...
    def create_pixels(self, plan, folder, source):
        ...
        if kind != 'scene':
            ...
            request = {'cell': {'width': plan['cell'], 'height': plan['cell'], 'safe_margin': max(3, plan['cell']//12)},
                ...
                'fit': {'pixel_unfake': True, 'logical_height': plan['cell'], 'palette_size': plan['palette'], 'align_x': 'foot-centroid', 'align_y': 'bottom', 'layout_mode': 'slots', 'outline': False,
                    'temporal_stabilize': {'enabled': True, 'threshold': 1}},
